...
print("you can use  my  voice support Assistent press 1")
a.speak("you can use  my voice support Assistent press 1")
print("you can use text base Assistant press 2")
a.speak("you can use text base Assistant press 2")
 ...
 while True:
    ...
    if (("dont " in p) or ("don't " in p) or ("not " in p) or ("Dont " in p) or ("Don't " in p) or ("Not " in p) or
        ...
        print("your operation is  successfull")
          ...
          ("start" in p) or ("Start" in p) or ("START" in p) or ("open" in p) or ("Open" in p) or ("OPEN" in p)):
        if (("notepad++" in p) or ("Notepad++" in p) or ("NOTEPAD++" in p) or ("Notepad++ editor" in p) or (
                "NOTEPAD++ editor" in p) or ("NOTEPAD++ EDITOR" in p)
            or ("notepad++ editor" in p)) and (("editor" in p) or ("EDITOR" in p) or ("Editor" in p)):
            os.system("notepad++")
            a.speak("WELLCOME TO NOTEPAD++ EDITOR")
        ...
        elif (("browser" in p) or ("Browser" in p) or ("BROWSER" in p) or ("google" in p) or ("Google" in p) or (
                "GOOGLE" in p)
              or ("chrome" in p) or ("Chrome" in p) or ("CHROME" in p)):
            a.speak("WELLCOME TO CHROME BROWSER")
            os.system("chrome")

        elif (((("media" in p) or ("Media" in p) or ("MEDIA" in p)) and (
                ("player" in p) or ("Player" in p) or ("PLAYER" in p)))
              or ((("video" in p) or ("Video" in p) or ("VIDEO" in p)) and (
                        ("player" in p) or ("Player" in p) or ("PLAYER" in p)))
              or ("wmplayer" in p) or ("Wmplayer" in p) or ("Wmplayer" in p)):
            a.speak("WELLCOME TO WINDOW MEDIA PLAYER")
            os.system("wmplayer")
        ...
        elif (("VLC PLAYER" in p) or ("VLC MEDIA PLAYER" in p) or ("vlc media player" in p) or ("Vlc Media Player") or (
                "vlc player" in p) or ("vlc" in p)):
            a.speak("WELLCOME TO VLC MEDIA PLAYER")
            os.system("vlc")
